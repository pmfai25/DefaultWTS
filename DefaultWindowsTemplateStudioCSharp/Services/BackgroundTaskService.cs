...
using DefaultWindowsTemplateStudioCSharp.Activation;
using DefaultWindowsTemplateStudioCSharp.BackgroundTasks;
using DefaultWindowsTemplateStudioCSharp.Core.Helpers;

using Windows.ApplicationModel.Activation;
using Windows.ApplicationModel.Background;

namespace DefaultWindowsTemplateStudioCSharp.Services
{
