...
using DefaultWindowsTemplateStudioCSharp.EventHandlers.Ink;
using DefaultWindowsTemplateStudioCSharp.Services.Ink.UndoRedo;

using Windows.UI.Input.Inking;
using Windows.UI.Xaml.Controls;

namespace DefaultWindowsTemplateStudioCSharp.Services.Ink
{
